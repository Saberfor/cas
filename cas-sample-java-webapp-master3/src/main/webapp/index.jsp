...
<p><b>Authenticated User Id client2:</b> <a href="https://www.gxc.com:9898/cas/logout?service=http://www.gxc.com:9001" title="Click here to log out"><%= request.getRemoteUser() %>
</a></p>
