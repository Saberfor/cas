package com.example.casrestclient.pack;
...
public class CasServerUtil{
        ...
        // 登录服务器地址
        private static final String CAS_SERVER_PATH="https://www.gxc.com:9898/cas";
        ...
        public static void main(String[] args) {
                ...
                try {
                    String tgt = getTGT("test", "111");
                    System.out.println("TGT："+tgt);

                    String service = "http://www.gxc.com:9000/";
...
//        CloseableHttpClient client = createHttpClientWithNoSsl(httpCookieStore);
                        ...
                        //params.add(new BasicNameValuePair("service", "http://www.gxc.com:9001/"));
